...
.styled form {
        ...
        .styled [type="button"] {
            ...
            background-color: #34db82; /* initial background color */
        ...
        .styled [type="submit"] {
            ...
            background-color: #dbd034; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
...
<footer style="background-color:lime;margin-top: 143; border: none;">
    <P style="color:darkblue; ;"align="center">Designed and Devoloped by Sai Darshini R S </P>
</footer>
</html>
...
<html>
    ...
    .styled form {
        ...
        .styled [type="button"] {
            padding: 10px 20px; /* button size */
            background-color: #db34c8; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
        ...
        .styled [type="submit"]:hover {
            background-color:green; /*background color on hover */
            color:#fffff; /*text color on hover */
        }
        .styled [type="text"] {
            margin-left: 500px;
            transition: background-color 0.3s; 
    ...
    <footer style="background-color:lime;margin-top: 64; border: none;">
        <P style="color:darkblue; ;"align="center">Designed and Devoloped by Sai Darshini R S 2023 </P>
    </footer>
</html>
...
<style>
    ...
    .styled form {
        ...
        .styled [type="button"] {
            padding: 10px 20px; /* button size */
            background-color: #db347c; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
...
<body>
    ...
    <div class="photos">
    <img src="SAI.png.png" height="200" width="180">
    <img src="cedric.png.jpg" height="200" width="200">
    <img src="zayn.png.jpg" height="200" width="200">
    <img src="Harry.png.jpg" height="200" width="200">
    <img src="ron.png.jpg" height="200" width="200">
    <img src="jk.png.jpg" height="200" width="200">
    <img src="emma.png.jpg" height="200" width="200">
</div>
<div CLASS="names">
    <P>MS SAI</P>    
    <P style="margin-left:40;">MR CEDRIC</P>    
    <P>MR ZAYN</P>    
    <P >MR HARRY</P>    
    <P>MR RON</P>    
    <P style="margin-left:10;">MR JEON </P>    
    <P style="margin-left:20;">MS EMMA</P>    
</div>
<DIV class="position">
    <p>[Founder] </p>
    <p style="margin-left:20;">[CEO]</p>
    <p style="margin-left:20;">[Co-Founder] </p>
    <p style="margin-left:20;">[Co-CEO] </p>
    <p style="margin-left:20;">[Director]</p>
    <p style="margin-left:20;">[Co-Director]</p>
    <p style="margin-left:20;">[Exec-Director] </p>
...
<head>
    ...
    <style>
        ...
        .styled [type="button"] {
            padding: 10px 20px; /* button size */
            background-color: #db3490; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
...
<footer style="background-color:lime; border: none;">
    <P style="color:darkblue;"align="center">Designed and Devoloped by Sai Darshini R S 2023 </P>
</footer>
</html>
...
<head>
    ...
    /* Change background color when input is focused */
    background-color: #c322a0; /* Adjust the color as needed */
}
        ...
        .styled [type="button"] {
            padding: 10px 20px; /* button size */
            background-color: #db4d34; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
        ...
        .styled [type="submit"] {
            border-radius: 10px;
            padding: 5px 10px; /* button size */
            background-color: #42db34; /* initial background color */
            color: #ffffff; /*initial text color */
            border: none;
            transition: background-color 0.3s, color 0.3s; /*smooth transition */
        }
...
<body>
    ...
    <div class="company">
        <center>
        <h3 style="color:burgundy;">COMPANY CONTACT INFORMATION</h3>
       <p> <b >Address</b></p>
        <p >no7,maple street</p>
        <p >Kingston</p>
        <p >New York 12401</p>
        <b >Email:</b>
        <p >saidarshini26@gmail.com</p>
        <b >Phone</b>
        <p >9876543210</p>
    </center>
    </div>
</body>
<footer style="background-color:lime;margin-top: 118px; border: none;">
    <P style="color:darkblue ;"align="center">Designed and Devoloped by Sai Darshini R S 2023 </P>
</footer>
</html>
...
### Home Page:
![Alt text](<Screenshot 2023-12-30 204828.png>)

### Product Page:
![Alt text](<Screenshot 2023-12-30 211922.png>)

### About Page:
![Alt text](<Screenshot 2023-12-30 211600.png>)

### Signup Page:
![Alt text](<Screenshot 2023-12-30 205302.png>)

### Contacts Page:
![Alt text](<Screenshot 2023-12-30 204919.png>)
## Result:
